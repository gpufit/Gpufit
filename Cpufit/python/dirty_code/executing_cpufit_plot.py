...
if __name__ == '__main__':
    ...
    # print('CUDA available: {}'.format(cf.cuda_available()))
    # if not cf.cuda_available():
    #     raise RuntimeError(cf.get_last_error())
    # print('CUDA versions runtime: {}, driver: {}'.format(*cf.get_cuda_version()))
