    ...
    mxArray const *prhs[])
{
    ...
    REAL * constraints = (REAL*)mxGetPr(prhs[8]);
    int * constraint_types = (int*)mxGetPr(prhs[9]);
	int * parameters_to_fit = (int*)mxGetPr(prhs[10]);
    int model_id = (int)*mxGetPr(prhs[11]);
    int n_parameters = (int)*mxGetPr(prhs[12]);
	int * user_info = (int*)mxGetPr(prhs[13]);
    std::size_t user_info_size = (std::size_t)*mxGetPr(prhs[14]);
