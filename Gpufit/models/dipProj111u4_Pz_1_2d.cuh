#ifndef DIPPROJ111U4_PZ_1_2D_INCLUDED
#define DIPPROJ111U4_PZ_1_2D_INCLUDED
...
*
*/
__device__ void calculate_dipProj111u4_Pz_1_2d(
    ...
    std::size_t const user_info_size)
{
    ...
    value[point_index] = prefac * ( AA*BB/CC52 + BB/CC32 / 3 );	
    ...
    float const dAdx0 = 0;
    float const dAdy0 = -rt2*Dz;
    float const dAdz0 = rt2*Dy-2*Dz;
    float const dAdmm = 0;
	...
	current_derivative[0 * n_points] = prefac * ( BB*dAdx0/CC52 + AA*dBdx0/CC52 + dBdx0/CC32 /3 - 2.5*AA*BB*dCdx0/CC72 - 0.5*BB*dCdx0/CC52 );
	current_derivative[1 * n_points] = prefac * ( BB*dAdy0/CC52 + AA*dBdy0/CC52 + dBdy0/CC32 /3 - 2.5*AA*BB*dCdy0/CC72 - 0.5*BB*dCdy0/CC52 );
	current_derivative[2 * n_points] = prefac * ( BB*dAdz0/CC52 + AA*dBdz0/CC52 + dBdz0/CC32 /3 - 2.5*AA*BB*dCdz0/CC72 - 0.5*BB*dCdz0/CC52 );
	current_derivative[3 * n_points] = prefac * ( BB*dAdmm/CC52 + AA*dBdmm/CC52 + dBdmm/CC32 /3 - 2.5*AA*BB*dCdmm/CC72 - 0.5*BB*dCdmm/CC52 );
}
#endif
