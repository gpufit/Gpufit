#ifndef DIPPROJ111U4_PZ_2_2D_INCLUDED
#define DIPPROJ111U4_PZ_2_2D_INCLUDED
...
*
*/
__device__ void calculate_dipProj111u4_Pz_2_2d(
    ...
    std::size_t const user_info_size)
{
    ...
    value[point_index] = prefac * ( AA_1*BB_1/CC52_1 + BB_1/CC32_1/3 +  AA_2*BB_2/CC52_2 + BB_2/CC32_2/3  );
