#ifndef DIPBIPROJY_2_2D_INCLUDED
#define DIPBIPROJY_2_2D_INCLUDED
...
*
*/
__device__ void calculate_dipBiProjY_2_2d(
    ...
    std::size_t const user_info_size)
{
    ...
    value[point_index] = prefac * ( 3*AA_1/CC52_1 - BB_1/CC32_1 + 3*AA_2/CC52_2 - BB_2/CC32_2 );	
