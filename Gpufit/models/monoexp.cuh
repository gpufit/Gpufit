#ifndef GPUFIT_MONOEXP_CUH_INCLUDED
#define GPUFIT_MONOEXP_CUH_INCLUDED
...
*
* The monoexponential function is: y = a*exp(-b*x)
* The derivatives are:
* dy/da = exp(-b*x)
* dy/db = a*(-x)*exp(-b*x)
*
...
__device__ void calculate_monoexp(
...
#endif // GPUFIT_MONOEXP_CUH_INCLUDED