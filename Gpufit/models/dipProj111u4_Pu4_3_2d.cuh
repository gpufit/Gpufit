#ifndef DIPPROJ111U4_PU4_3_2D_INCLUDED
#define DIPPROJ111U4_PU4_3_2D_INCLUDED
...
*             p[0]: center coordinate x, dipole 2
*             p[1]: center coordinate y, dipole 2
*             p[2]: center coordinate z, dipole 2
*             p[3]: dipole moment magnitude mm, dipole 2
*             p[0]: center coordinate x, dipole 3
*             p[1]: center coordinate y, dipole 3
*             p[2]: center coordinate z, dipole 3
*             p[3]: dipole moment magnitude mm, dipole 3
*
...
*
*/
__device__ void calculate_dipProj111u4_Pu4_3_2d(
    ...
    std::size_t const user_info_size)
{
    ...
    float const AA_3 = rt3*Dy_3 - Dz_3;
    ...
    value[point_index] = prefac * ( AA_1*AA_1*BB_1/CC52_1 - BB_1/CC32_1  +  AA_2*AA_2*BB_2/CC52_2 - BB_2/CC32_2  +  AA_3*AA_3*BB_3/CC52_3 - BB_3/CC32_3  );
    ...
    float const dAdy0_3 = -rt3;
    float const dAdz0_3 = -1;
  ...
  current_derivative[8  * n_points] = prefac * ( 2*AA_3*BB_3*dAdx0_3/CC52_3 + AA_3*AA_3*dBdx0_3/CC52_3 - dBdx0_3/CC32_3 - 2.5*AA_3*AA_3*BB_3*dCdx0_3/CC72_3 + 1.5*BB_3*dCdx0_3/CC52_3 );
  current_derivative[9  * n_points] = prefac * ( 2*AA_3*BB_3*dAdy0_3/CC52_3 + AA_3*AA_3*dBdy0_3/CC52_3 - dBdy0_3/CC32_3 - 2.5*AA_3*AA_3*BB_3*dCdy0_3/CC72_3 + 1.5*BB_3*dCdy0_3/CC52_3 );
  current_derivative[10 * n_points] = prefac * ( 2*AA_3*BB_3*dAdz0_3/CC52_3 + AA_3*AA_3*dBdz0_3/CC52_3 - dBdz0_3/CC32_3 - 2.5*AA_3*AA_3*BB_3*dCdz0_3/CC72_3 + 1.5*BB_3*dCdz0_3/CC52_3 );
  current_derivative[11 * n_points] = prefac * ( 2*AA_3*BB_3*dAdmm_3/CC52_3 + AA_3*AA_3*dBdmm_3/CC52_3 - dBdmm_3/CC32_3 - 2.5*AA_3*AA_3*BB_3*dCdmm_3/CC72_3 + 1.5*BB_3*dCdmm_3/CC52_3 );
}
#endif
