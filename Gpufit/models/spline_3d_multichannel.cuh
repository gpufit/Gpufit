#ifndef GPUFIT_SPLINE3D_MULTICHANNEL_CUH_INCLUDED
#define GPUFIT_SPLINE3D_MULTICHANNEL_CUH_INCLUDED

/* Description of the calculate_spline3d_multichannel function
* ============================================================
*
...
*                   .
*                   .
*                user_info[7+Ni*64]: the value of coefficient (0,0,0) of intervall (0,0,0,1)
...
*
* Calling the calculate_spline3d_multichannel function
* ====================================================
*
...
__device__ void calculate_spline3d_multichannel(
